"""Valid timezone names for GET /api/{username}/info/timezones.

Ported from diyHue's BridgeEmulator/functions/core.py::capabilities()
(Apache-2.0) — see /NOTICE. The Hue app's timezone-picker screen (shown
during onboarding, and again any time it thinks the bridge's timezone isn't
set) fetches this list to populate itself; without it the picker has nothing
to show and the app is left re-prompting indefinitely.
"""
...
TIMEZONES = [
    ...
    "GB-Eire", "HST", "Hongkong", "Iceland", "Iran", "Israel", "Jamaica",
    "Japan", "Kwajalein", "Libya", "MET", "MST", "MST7MDT", "NZ", "NZ-CHAT",
    "Navajo", "PRC", "PST8PDT", "Poland", "Portugal", "ROC", "ROK",
    "Singapore", "Turkey", "W-SU", "WET",
    ...
    "America/Antigua", "America/Araguaina", "America/Aruba",
    ...
    "America/Havana", "America/Hermosillo", "America/Indianapolis",
    "America/Inuvik", "America/Iqaluit", "America/Jamaica", "America/Jujuy",
    "America/Juneau", "America/Knox_IN", "America/Kralendijk",
    ...
    "America/Noronha", "America/Nuuk", "America/Ojinaga", "America/Panama",
